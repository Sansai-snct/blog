          ...
          {allPosts.map((post) => (
            <li className='p-6  h-48 bg-whiterounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700'>
              ...
              <a
                href={post.slug}
                key={post.slug}
                className='inline-flex items-center mx-20  md:mx-36 py-2 px-3 text-sm font-medium  text-white bg-blue-700 rounded-lg w-32 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
              >
                Read more
                <svg
