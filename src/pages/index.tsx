  ...
  return (
    <div>
      <Layout pageTitle='blog|TOP'>
        ...
        <ul className='grid  justify-center grid-rows-2 lg:grid-cols-2 lg:gap-4   lg:ml-72 lg:mr-72 mb-4 mt-10'>
          {allPosts.map((post) => (
            <li className='p-6  h-48 bg-white rounded-lg border border-gray-200 shadow-md  dark:bg-gray-800 dark:border-gray-700'>
