  ...
  return (
    <div>
      <Layout pageTitle='blog|TOP'>
        ...
        <ul className='flex  ml-20  md:mr-4 mb-4 mt-10'>
          {allPosts.map((post) => (
            <li className='p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700'>
